...
// °¢Á¾ º¯¼ö
	...
	private RoomInfo roomInfo; // »ç¿ëÀÚ°¡ »ı¼ºÇÑ ¹æÀÇ °´Ã¼
...
//			new PaintEx(room_No);
		...
		// #Ã¤ÆÃ
		case "ChattingWR":
			/* Ã¤ÆÃÀ» Àü´ŞÇÒ ¶§, ¸Ş½ÃÁö¿¡ µô¸®¹ÌÅÍ°¡ Æ÷ÇÔµÇ¾î ÀÖÀ» °æ¿ì
			 * ¸Ş½ÃÁöµµ Àß·Á¼­ Àü¼ÛµÇ¹Ç·Î ÇØ´ç ³»¿ëÀÌ Ã¤ÆÃÀÏ °æ¿ì 
			 * ÅäÅ©³ªÀÌÀú·Î Àß·ÁÁø ¸Ş½ÃÁö¸¦ ´Ù½Ã °áÇÕÇØ¼­ Àü¼ÛÇÑ´Ù. */
	...
	private void createRoom() {
		...
		for(int i=0; i<gameRoom.length; i++) {
			...
			if(i<room_list.size()) {
				...
				grp.setRoomInfo(r); // ÇØ´ç grp¿¡ RoomInfo °´Ã¼¸¦ ÀúÀå½ÃÅ²´Ù.
...
//			});
	...
	class inputPw extends JFrame {
		...
		public inputPw(String pw) {
			...
			JLabel inputPW_lb = new JLabel("ºñ¹Ğ¹øÈ£¸¦ ÀÔ·ÂÇÏ¼¼¿ä.");
			...
			inputPW_tf.setBackground(new Color(0,0,0,0)); // ¹è°æ Åõ¸í»ö
			inputPW_tf.setFont(wrFont);
			inputPW.add(inputPW_tf);
			
			JButton inputPW_bt = new JButton("ÀÔ·Â");
			...
			inputPW_bt.addMouseListener(new MouseAdapter() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
//					inputPW_bt.setIcon(exitEnteredImage); // ¸¶¿ì½º¸¦ ¿Ã·Á³ùÀ»¶§ ÀÌ¹ÌÁö º¯°æ(Entered Image)
...
//					inputPW_bt.setCursor(myCursor);
				...
				@Override  
				public void mouseExited(MouseEvent e) {
//					inputPW_bt.setIcon(exitBasicImage); // ¸¶¿ì½º¸¦ ¶¼¾úÀ»¶§ ÀÌ¹ÌÁö º¯°æ(Basic Image)
...
//							new PaintEx(room_No);
			...
			JButton cancel_bt = new JButton("Ãë¼Ò");
			...
			cancel_bt.addMouseListener(new MouseAdapter() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
//					cancel_bt.setIcon(exitEnteredImage); // ¸¶¿ì½º¸¦ ¿Ã·Á³ùÀ»¶§ ÀÌ¹ÌÁö º¯°æ(Entered Image)
...
//					cancel_bt.setCursor(myCursor);
				...
				@Override  
				public void mouseExited(MouseEvent e) {
//					cancel_bt.setIcon(exitBasicImage); // ¸¶¿ì½º¸¦ ¶¼¾úÀ»¶§ ÀÌ¹ÌÁö º¯°æ(Basic Image)
